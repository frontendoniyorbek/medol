...
const Hero = () => {
	return (
		<div className={`${styleHero.hero} pt-[39px] pb-12 flex items-center justify-between`}>
			<div className={`flex ${styleHero.social}`}>
				<div className={`flex items-center mr-[41px] ${styleHero.location}`}>
				...
				<div className={`flex items-center mr-10 ${styleHero.tell}`}>
					<div className='cursor-pointer w-[50px] h-[50px] rounded-full bg-white mr-5 flex justify-center items-center'>
			...
			<div className={`ml-11 mr-32 text-center ${styleHero.logo}`}>
				<Image src={logo} alt='logo' width={200} height={58} />
			</div>

			<div className={`${styleHero.till} flex`}>
				<div className={`flex items-center ml-3 mr-14 ${styleHero.search}`}>
				...
				<div className={`${styleHero.facebook} flex items-center mr-12`}>
				...
				<div className='flex items-center'>
					<div className='pt-[14px] pr-[25px] pb-[14px] pl-[25px]  cursor-pointer rounded-[25px] bg-white mr-5 flex justify-center items-center'>
