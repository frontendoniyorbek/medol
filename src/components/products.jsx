...
const Products = () => {
	return (
		<div className={`md:pt-[50px] md:pb-[67px] sm:pt-9 sm:pb-10 pt-6 pb-6 ${products.products__container}`}>
			<h2 className='text-[#0D4C93] text-center font-medium lg:text-[40px] md:text-3xl sm:text-2xl text-2xl lg:mb-[62px] md:mb-12 sm:mb-8 mb-6 leading-[1.2]'>
				ПРОДУКЦИЯ
			</h2>
			<ul className={`list-none flex items-center sm:justify-between justify-center flex-wrap ${products.products__ul}`}>
				<li
					...
					<h3 className='md:text-2xl sm:text-xl text-base text-center mt-0 md:mb-7 sm:mb-5 mb-4'>Эндоваскулярная хирургия</h3>
					<button className='whitespace-nowrap sm:mb-0 mb-4 btn btn__products'>Посмотреть все</button>
				</li>
				...
				<li
					...
					<h3 className='md:text-2xl sm:text-xl text-base text-center mt-0 md:mb-7 sm:mb-5 mb-4'>
				...
				<li
					...
					<h3 className='md:text-2xl sm:text-xl text-base text-center mt-0 md:mb-7 sm:mb-5 mb-4'>ДИАБЕТ</h3>
					<button className='whitespace-nowrap sm:mb-0 mb-4 btn btn__products'>Посмотреть все</button>
				</li>
				...
				<li
					...
					<h3 className='md:text-2xl sm:text-xl text-base text-center mt-0 md:mb-7 sm:mb-5 mb-4'>ЭНДОУРОЛОГИЯ</h3>
					<button className='whitespace-nowrap sm:mb-0 mb-4 btn btn__products btn__products--active'>Посмотреть все</button>
				</li>

				<li
					className={`flex flex-col items-center justify-center opacity-90 md:pt-[17px] md:pr-[72px] md:pb-[42px] md:pl-[72px] sm:pt-3 sm:pb-7 sm:pr-9 sm:pl-9 rounded-[35px] ${products.products__li}`}>
					<Image className={`mb-2 ${products.products__image}`} src={aritmologiya} width={220} height={220} />
					<h3 className='md:text-2xl sm:text-xl text-base text-center mt-0 md:mb-7 sm:mb-5 mb-4'>АРИТМОЛОГИЯ</h3>
					<button className='whitespace-nowrap sm:mb-0 mb-4 btn btn__products'>Посмотреть все</button>
				</li>
			</ul>
